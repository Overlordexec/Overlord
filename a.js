...
var footer_html='<div class="footer-logo"><img src="overlord.png" alt="Overlord" onerror="this.style.display=\'none\';this.nextElementSibling.style.display=\'flex\';"><div class="footer-logo-fb" style="display:none;"><i class="fa-solid fa-z"></i></div></div><span class="footer-text"><strong>Overlord</strong></span><div class="footer-dot"></div><span class="footer-text">&copy; 2026 All rights reserved.</span>';
...
t.className='toast';
t.innerHTML='<img src="overlord.png" class="toast-logo" alt="" onerror="this.style.display=\'none\';this.nextElementSibling.style.display=\'flex\';"><div class="toast-logo-fb" style="display:none;"><i class="fa-solid fa-z"></i></div><div class="toast-content"><span class="toast-title">Overlord</span><span class="toast-msg">'+name+' is '+text+'</span></div>';
c.appendChild(t);
